...
// Match this ID to your Play Console yearly subscription product.
const String kProYearlyProductId = 'yearly';
...
class BillingService {
  ...
  bool get hasProducts =>
      ...
      _productsById.containsKey(kProYearlyProductId);
  ...
  PurchaseParam _buildPurchaseParam({
    ...
    // Yearly plan does not use the weekly trial offer token.
    if (plan != BillingPlan.freeTrial) {
      return PurchaseParam(productDetails: productDetails);
    }
