...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get chatbotHeadlineSubtitle =>
      'ارفع ملف PDF واسأل أي شيء — احصل على إجابات فورية وملخصات وشروحات والمزيد.';
  ...
  @override
  String get pdfAssistantTranslateToOptional => 'الترجمة إلى (اختياري)';

  @override
  String get pdfAssistantNoTranslation => 'بدون ترجمة';

  @override
  String get pdfAssistantExtractedPdfTitle => 'PDF مستخرج';

  @override
  String get pdfAssistantExtractedPdfDescription =>
      'النص المستخرج من صفحات PDF';

  @override
  String get pdfAssistantExtractedTextOnlyTitle => 'نص مستخرج';

  @override
  String get pdfAssistantStepPreparingContent => 'جارٍ تحضير المحتوى…';

  @override
  String get pdfAssistantStepGeneratingPdfNeutral => 'جارٍ إنشاء PDF…';
  ...
  @override
  String get splashAdDisclaimer => 'قد يؤدي هذا الإجراء إلى إعلان';
  ...
  @override
  String get smartCropPresetAuto => 'اكتشاف تلقائي';

  @override
  String get smartCropPresetCenter => 'صفحة مركزية';

  @override
  String get smartCropPresetFull => 'الصورة كاملة';

  @override
  String get smartCropUploadIntroGoogleScanner =>
      'Google Scanner (أفضل اقتصاص)';
  ...
  String smartCropImportReadingProgress(int done, int total) {
    return 'قراءة $done من $total…';
  }

  @override
  String smartCropImportPartialFailure(int failed, int total) {
    return 'تعذر استيراد $failed من $total صورة';
  }
